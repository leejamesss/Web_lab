...
<%--			<option value="id">图书编号</option>--%>
			<option value="wherefrom">来源</option>
			<option value="bname">图书名称</option>
        	<option value="person_in_charge">作者</option>
<%--			<option value="position">位置</option>--%>
			<option value="introduction">简介</option>
	...
	layui.use(['table','jquery'], function(){
	  ...
	  var tableIns =  table.render({
	    ...
	    ,cols: [[
	      ...
	      ,{field:'bname', width:200, title: '图书名称', sort: true}
	      ,{field:'person_in_charge', width:250, title: '作者', sort: true}
		  ...
		  ,{field: 'CLC',minWidth: 80, title: '分类号'}
