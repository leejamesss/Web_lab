...
//				String sql2 = "select * from like_sort where ID =" + sortid;
...
//				jsonData.put("id", resultSet.getString("id"));
                ...
                jsonData.put("press", resultSet.getString("press"));
                jsonData.put("introduction", resultSet.getString("introduction"));
                jsonData.put("bdate", resultSet.getString("bdate"));
                jsonData.put("price", resultSet.getString("price"));
                jsonData.put("ISBN/ISRC", resultSet.getString("ISBN/ISRC"));
                jsonData.put("CLC", resultSet.getString("CLC"));
                jsonData.put("page_number", resultSet.getString("page_number"));
                jsonData.put("size", resultSet.getString("size"));
...
//				jsonData.put("description", resultSet.getString("description"));
            ...
            countSql = "select count(*) as count from likeinfo";
            countSql += where;
