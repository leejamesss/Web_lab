/**
 * The XSSFilter class is a Java filter that removes potential XSS (Cross-Site Scripting) attacks from
 * user input by filtering out script, style, and HTML tags.
 */
package filter;
