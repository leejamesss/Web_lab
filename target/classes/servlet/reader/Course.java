...
//				jsonData.put("id", resultSet.getString("id"));
                jsonData.put("Cno", resultSet.getString("Cno"));
                jsonData.put("Cname", resultSet.getString("Cname"));
                jsonData.put("Cyear", resultSet.getString("Cyear"));
                jsonData.put("location", resultSet.getString("location"));
                jsonData.put("Exam", resultSet.getString("Exam"));
...
//				jsonData.put("description", resultSet.getString("description"));
            ...
            countSql = "select count(*) as count from courseinfo ";
            countSql += where;
